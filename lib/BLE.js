class BLE{
	...
	//开始外围设备,匹配设备名称和mac地址获取设备id,此处判断为相同设备的条件为mac地址和设备名称与传入的参数相同,如不需要可自行去除
	/**
	 *
